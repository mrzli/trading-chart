...
import { getTimeTickPositionFirst } from './time-tick-position';

describe('time-tick-position', () => {
  describe('getTimeTickPositionFirst()', () => {
    ...
    const EXAMPLES: readonly Example[] = [
      ...
      {
        description: 'D 1 (4) - timezone is irrelevant for days, only UTC day is considered',
        input: {
