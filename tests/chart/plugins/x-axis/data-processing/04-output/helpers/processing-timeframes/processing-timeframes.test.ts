...
describe('processing-timeframes', () => {
  describe('getTimeAxisProcessingTimeframes()', () => {
    interface Example {
      readonly input: {
        readonly from: TimeTickTimeframe;
        readonly to: TimeTickTimeframe;
      };
      readonly expected: readonly TimeTickTimeframe[];
    }
    ...
    for (const example of EXAMPLES) {
      it(toDescription(example), () => {
        ...
        const actual = getTimeAxisProcessingTimeframes(from, to);
